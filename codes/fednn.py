...
Original file is located at
    https://colab.research.google.com/drive/1GqoAzBoMFiU3N0ayDO4XJ0sPUOmnrGGi
"""
...
class fednn_classifier(fednn_client):
    """fednn client for classification tasks"""
    ...
    def predict(self, X):
        """Predict using fednn model for classification.
...
class fednn_regressor(fednn_client):
    """fednn client for regresion tasks"""
    ...
    def predict(self, X):
        """Predict using fednn model for regresion.
...
#
##########################################################################
class fednn_coordinator:
    """fednn coordinator class.
