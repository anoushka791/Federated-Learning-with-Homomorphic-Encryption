...
Data = pd.read_csv("D:\Downloads\carbon_nanotubes.csv", delimiter=';')

# Replace commas with periods and convert to float
Data = Data.apply(lambda x: x.str.replace(',', '.').astype(float) if x.name != "Chiral indice n" and x.name != "Chiral indice m" else x)
