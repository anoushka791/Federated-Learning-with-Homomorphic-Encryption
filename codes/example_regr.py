...
Original file is located at
    https://colab.research.google.com/drive/15TLXXeORZpFWR2ex2SBGnvsLk47TfMgl
"""
...
from fednn import fednn_regressor, fednn_coordinator
...
for i in range(0, n_clients):
    clients.append(fednn_regressor(f='lin'))
...
coordinator = fednn_coordinator(f='lin', lam=0.01)
