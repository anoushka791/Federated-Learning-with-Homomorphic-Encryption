...
Original file is located at
    https://colab.research.google.com/drive/1cmQtkUHfxYL1JvQ-g23UTiJ9f56RY94v
"""
...
from fednn import fednn_classifier, fednn_coordinator
...
for i in range(0,n_clients):
    clients.append(fednn_classifier(f='logs'))
...
coordinator = fednn_coordinator(f='logs', lam=0.01)
